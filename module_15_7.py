...
time_step = 10 # увеличен размер окна
...
model.add(LSTM(60, return_sequences=True)) # первый слой
model.add(Dropout(0.2)) # сигнал с вероятностью 20% для предотвращения переобучения
model.add(LSTM(60, return_sequences=False)) # второй слой
model.add(Dropout(0.2))
model.add(Dense(30))# полносвязный слой
